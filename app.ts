...
class UI{
    addieentrytoList(ieentry:Ieentry)
    {
...
class LocalStore{
    ...
    static getieentriesfromLS() :Array<Ieentry>{
        let ieentriesdateasstring: Array<IeentryDateasString>=[];
        let ieentries:Array<Ieentry>=[];
    ...
    static displayieentries() {
        const ieentries:Array<Ieentry> = LocalStore.getieentriesfromLS();
    ...
    static addieentry(ieentry:Ieentry) {
        const ieentries:Array<Ieentry> = LocalStore.getieentriesfromLS();   
    ...
    static removeieentry(ieentrytobedeleted:Ieentry) {
        const ieentries :Array<Ieentry>= LocalStore.getieentriesfromLS();
